...
import 'package:mobile/widgets/favorite_product_card.dart';
...
class FavoritePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemCount: 10, // Number of favorite products
      itemBuilder: (context, index) {
        int x = Random().nextInt(1000) % 7;
        return Padding(
          padding: EdgeInsets.only(bottom: 12.h),
          child: FavoriteProductCard(product: products[x]),
        );
      },
    );
  }
